...
class MooncakeStoreConfig:
    ...
    def create() -> "MooncakeStoreConfig":
        ...
        if file_path is None:
            ...
            global_segment_size = int(envs.MOONCAKE_GLOBAL_SEGMENT_SIZE or DEFAULT_GLOBAL_SEGMENT_SIZE)
            local_buffer_size = int(envs.MOONCAKE_LOCAL_BUFFER_SIZE or DEFAULT_LOCAL_BUFFER_SIZE)
